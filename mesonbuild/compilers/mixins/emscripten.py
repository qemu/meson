...
class EmscriptenMixin(Compiler):
    ...
    def wrap_js_includes(self, args: T.List[str]):
        final_args = []
        for i in args:
    ...
    def native_args_to_unix(cls, args: T.List[str]) -> T.List[str]:
        return cls.wrap_js_includes(super().native_args_to_unix(args))

    def get_dependency_link_args(self, dep: 'Dependency') -> T.List[str]:
        return self.wrap_js_includes(super().get_dependency_link_args(dep))

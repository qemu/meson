...
class PythonExternalProgram(ExternalProgram):
    ...
    def sanity(self) -> 'PythonExternalProgram':
...
class PythonModule(ExtensionModule):
    ...
    def find_installation(self, state: 'ModuleState', args: T.Tuple[T.Optional[str]],
        ...
        if not python.found():
            ...
            if required and (not isinstance(python, PythonExternalProgram) or not self._check_version(name_or_path, python.info['version'])):

...
class AllPlatformTests(BasePlatformTests):
    ...
    def test_replace_unencodable_xml_chars_unit(self):
        ...
        testdir = os.path.join(self.unit_test_dir, '113 replace unencodable xml chars')
        self.init(testdir)
    ...
    def test_executable_names(self):
        testdir = os.path.join(self.unit_test_dir, '123 executable suffix')
        self.init(testdir)
        self.build()
    ...
    def test_options_listed_in_build_options(self) -> None:
        ...
        testdir = os.path.join(self.unit_test_dir, '115 list build options')
    ...
    def test_symlinked_subproject(self):
        testdir = os.path.join(self.unit_test_dir, '110 subproject symlink')
    ...
    def test_configure_same_noop(self):
        testdir = os.path.join(self.unit_test_dir, '111 configure same noop')
        args = [
            '-Dstring=val',
            '-Dboolean=true',
            '-Dcombo=two',
    ...
    def test_c_cpp_stds(self):
        testdir = os.path.join(self.unit_test_dir, '117 c cpp stds')
        self.init(testdir)

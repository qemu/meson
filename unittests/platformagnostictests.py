...
class PlatformAgnosticTests(BasePlatformTests):
    ...
    def test_setup_loaded_modules(self):
        ...
        good.
        '''
        testdir = os.path.join(self.unit_test_dir, '118 empty project')
    ...
    def test_meson_package_cache_dir(self):
        ...
        testdir = os.path.join(self.unit_test_dir, '120 meson package cache dir')
    ...
    def test_cmake_openssl_not_found_bug(self):
        """Issue #12098"""
        testdir = os.path.join(self.unit_test_dir, '121 openssl cmake bug')
